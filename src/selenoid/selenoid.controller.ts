...
export class SelenoidController {
  ...
  @Post('mail')
  async changeMailForward(@Req() req: Request, @Query() params: MailForward, @Res() res: Response) {
    try {
  ...
  @Post('queue')
  async setQueueStatus(@Req() req: Request, @Query() params: Queue, @Res() res: Response) {
    try {
  ...
  @Post('forward')
  async setForward(@Req() req: Request, @Query() params: Forward, @Res() res: Response) {
    try {
