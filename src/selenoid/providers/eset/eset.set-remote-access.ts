...
export class EsetSetRemoteAccess implements SelenoidProviderInterface {
    ...
    private async changeOtp(): Promise<void> {
        ...
        await this.webDriver
            .findElement(By.xpath("(//td[contains(text(), 'Mobile Application OTP')]//parent::tr//td)[2]//div//div"))
            .click();
    ...
    private async changePush(): Promise<void> {
        ...
        await this.webDriver
            .findElement(By.xpath("(//td[contains(text(), 'Mobile Application Push')]//parent::tr//td)[2]//div//div"))
            .click();
